...
class Forum extends Base {
    ...
    getById (userid, batch) {
        ...
        const field       = useridRe.test(userid) ? // eslint-disable-line operator-linebreak
            `${tokenConfig.forumUserTable}.userid = ?` : // eslint-disable-line operator-linebreak,indent
