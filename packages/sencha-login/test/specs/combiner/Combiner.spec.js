...
describe('combiner/Combiner', function () {
    let combiner;
    ...
    describe('instantiation', function () {
        ...
        it('should be an login combiner', function () {
            expect(combiner).to.have.property('isLoginCombiner', true);
        });
